document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeHangman(playerName, category) {
        ...
        var hangmanContainer = document.getElementById('hangmanContainer');
        ...
        document.getElementById('hangman-guess-btn').addEventListener('click', function() {
            if (count > 0) {
                ...
                if (count == 5) {
                    ...
                    hangmanContainer.style.backgroundColor="white";
                } else if (count == 4) {
                    
                    hangmanContainer.style.backgroundImage = "url('images/hang1.png')";
                } else if (count == 3) {
                    hangmanContainer.style.backgroundImage = "url('images/hang2.png')";
                } else if (count == 2) {
                    hangmanContainer.style.backgroundImage = "url('images/hang3.png')";
                } else if (count == 1) {
                    hangmanContainer.style.backgroundImage = "url('images/hang4.png')";
                }
            }
        });
        ...
        function checkGameStatus() {
            if (disp.join('') === chosenWord) {
                ...
                hangmanContainer.style.backgroundImage= "url('images/hang5.png')";
